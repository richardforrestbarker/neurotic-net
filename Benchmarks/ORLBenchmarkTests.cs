...
{
    /// <summary>
    /// ORL benchmark: Tests network on face recognition
    /// Dataset: 112x92 grayscale face images, 40 subjects
    /// </summary>
    [TestFixture]
    public class ORLBenchmarkTests
    {
        private const string DatasetPath = "./data/orl";

        [Test]
        public void ORL_NetworkCanBeCreated()
        {
            var settings = BenchmarkSettings.ORL;
        ...
        [Test]
        public void ORL_NetworkCanCalculate()
        {
            var settings = BenchmarkSettings.ORL;
        ...
        [Test]
        public void ORL_NetworkCanBeTrainedWithSyntheticData()
        {
            var settings = BenchmarkSettings.ORL;
